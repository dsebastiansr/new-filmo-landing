...
export default function CTA() {
  return (
    <div
      className="relative z-10 flex h-[500px] max-md:h-[250px] w-full flex-col items-center justify-center gap-10"
      id="cta"
    >
      <div className="flex flex-col items-center gap-0">
        ...
        <h1 className="font-garamond text-filmo-white w-[20ch] text-center max-md:text-3xl text-7xl font-extrabold">
