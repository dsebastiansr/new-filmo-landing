...
export default function Navbar() {
  ...
  return (
    <nav
      id="navbar"
      className="fixed z-50 flex w-full items-center justify-between bg-linear-to-b from-[#0C0A09] to-white/0 px-42 py-12 transition-all duration-300 max-md:h-24 max-md:px-8 max-md:items-center"
    >
      <Link href="/" className="">
        <Image
          id="navbar-logo"
          src="/svg/filmo.svg"
          className="z-20 h-20 max-md:h-10 transition-all duration-300"
          alt=""
          width={96}
          height={24}
        />
